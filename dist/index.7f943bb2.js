...
const projectList = [
    ...
    },
    {
        ...
        githubUrl: "https://github.com/Young-Einstein10/30DaysOfCode/tree/master/Day18",
...
const listTechnologies = (technologies)=>technologies.map((tech)=>`<li class="stack-item">${tech}</li>`
    ).toString().split(",").join(" ")
;
const projectTemplate = ({ name , description , githubUrl , deployedUrl , technologies ,  })=>`
            ...
            <header>
              <div class="link-out d-flex justify-content-end">
                <div>
                  ...
                  ${deployedUrl ? `<a href=${deployedUrl} target="_blank" rel="nofollow noopener noreferrer" aria-label="External Link" class="">
